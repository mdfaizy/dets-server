...
const {
  ...
  forgotPassword,
  resetPassword,
} = require("../controllers/studentsignin.js");
// const { newAdmission } = require("../controllers/newAdmission.js");
// const {
//   getNewAdmissionById,
//   get_new_admission,
//   delete_newadmission,
//   update_New_Admission,
// } = require("../controllers/getNewAdmission.js");
// const {
//   exitStudent,
//   get_exitstudent,
...
//   delete_id_pgstudent,
//   update_pg_cource,
// } = require("../controllers/pgcource.js");
const {
  job,
  get_job_student,
  get_all_Job_student,
} = require("../controllers/jobDetails.js");
//post data routes
